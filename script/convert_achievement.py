#!/usr/bin/env python3
"""Convert Traditional Chinese to Simplified for achievement_list.lua fields.

高效版本：单次遍历完成所有转换
处理字段：title, content, resource
"""
import re
import argparse
...
def main():
    parser = argparse.ArgumentParser(description='繁体转简体 - achievement_list.lua')
